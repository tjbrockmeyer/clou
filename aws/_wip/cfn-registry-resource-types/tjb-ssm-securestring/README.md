...
1. Write the JSON schema describing your resource, [tjb-ssm-securestring.json](./tjb-ssm-securestring.json)
2. Implement your resource handlers in [handlers.ts](./tjb-ssm-securestring/handlers.ts)

> Don't modify [models.ts](./tjb-ssm-securestring/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
